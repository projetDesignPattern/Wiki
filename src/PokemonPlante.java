...
public class PokemonPlante implements Pokemon{
    ...
    public PokemonPlante(String name) {
        this.name = name;
        level = 1;
        type="PLANTE";
        nombreEvolution = 0;
    ...
    public PokemonPlante(String name, List<Capacite> capacites, int pv, int nombreEvolution) {
        this.name = name;
    ...
    public PokemonPlante(String name, String alias, List<Capacite> capacites, int pv, int nombreEvolution) {
        this.name = name;
        this.alias = alias;
        this.capacites = capacites;
        this.pv = pv;
    ...
    public boolean equals(Object o) {
        ...
        PokemonPlante that = (PokemonPlante) o;
